...
export const postDetailDummy = {
    ...
    category: "",
    // post_content: "<p>IntelliJ는 정말 강력한 IDE지만, 추가적인 설정과 플러그인을 이용하면 더더욱 강력해진다.</p><p>이번 글에서는 유용한 설정과 플러그인에 대해서 소개하겠다.</p> <h2 id=\"유용한-설정\">유용한 설정</h2> <h3 id=\"1-auto-import\">1. Auto Import</h3> <p>코드를 작성하다 보면 다양한 패키지를 사용하게 된다. 하지만, 코드가 변경될 때 마다 import문을 삽입/삭제하는 것은 상당히 귀찮다. 이러한 귀찮음을 해결해주는 옵션이 Auto Import 옵션이다.</p> <p><img src=\"https://velog.velcdn.com/images/jeong_hun_hui/post/d47116e1-edf1-4e27-8658-873c6bd4c328/image.png\"></p> <p>Settings에서 Editor → General → Auto Import → Optimize imports on the fly 를 체크하면 된다.</p> <p><img src=\"https://velog.velcdn.com/images/jeong_hun_hui/post/c4669d5f-2fc5-4b6e-8434-47a6b0dc0806/image.png\"></p> <p>바로 위의 Insert imports on paste에서 코드를 붙혀넣기한 경우에 import문을 어떻게 삽입할지 선택할 수 있다.</p> <ul> <li><strong>Always</strong>: 자동 import</li> <li><strong>Ask</strong>: 확인한 뒤 import</li> <li><strong>Never</strong>: import 하지 않음</li> </ul> <h3 id=\"2-live-template-설정\">2. Live Template 설정</h3> <p>Java 코드를 작성하다 보면 <code>System.out.println()</code>나 <code>public static void main(String[] args) {}</code>같이 비슷한 형태의 코드를 작성해야할 일이 자주 있다.</p> <p><img src=\"https://velog.velcdn.com/images/jeong_hun_hui/post/06d08ad1-ef3c-4573-8010-6edd9a7ec350/image.png\"></p> <p>이럴 때 Live Template 설정을 해놓는다면 이렇게 자주 사용되는 형태의 코드를 위와 같이 줄임말(<code>sout</code>, <code>psvm</code> 등)을 통해 간단하게 작성할 수 있다.</p> <p>설정 방법은 아래와 같다.</p>"
